...
const cheddar = {
    // Element access
    element: () => ({ handleStart: () => { } }), // Dummy object for React compatibility
    e: () => ({ handleStart: () => { } }), // Dummy object for React compatibility
    ...
    setStatus: (text) => ipcRenderer.send('update-status', text),
    setResponse: (response) => ipcRenderer.send('update-response', response),
    // Core functionality
    initializeGemini,
    startCapture,
    stopCapture,
