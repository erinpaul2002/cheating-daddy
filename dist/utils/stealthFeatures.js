...
exports.applyStealthMeasures = applyStealthMeasures;
exports.startTitleRandomization = startTitleRandomization;
exports.applyAntiAnalysisMeasures = applyAntiAnalysisMeasures;
...
function applyStealthMeasures(mainWindow) {
    ...
    if (process.platform === 'darwin') {
        try {
            const randomName = (0, processNames_1.getCurrentRandomDisplayName)();
            electron_1.app.setName(randomName);
