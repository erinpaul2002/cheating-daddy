// prompts.ts - AI system prompts and profile configurations
...
type ProfilePrompts = Record<ProfileType, PromptParts>;

export const profilePrompts: ProfilePrompts = {
    interview: {
...
function buildSystemPrompt(promptParts: PromptParts, customPrompt: string = '', googleSearchEnabled: boolean = true): string {
    const sections: string[] = [promptParts.intro, '\n\n', promptParts.formatRequirements];
...
export function getSystemPrompt(profile: ProfileType, customPrompt: string = '', googleSearchEnabled: boolean = true): string {
