...
function analyzeAudioBuffer(buffer: Buffer, label: string = 'Audio'): AudioAnalysis {
...
function saveDebugAudio(buffer: Buffer, type: string, timestamp: number = Date.now()): DebugAudioPaths {
...
export { pcmToWav, analyzeAudioBuffer, saveDebugAudio };
