...
export const AppHeader: React.FC<AppHeaderProps> = ({ currentView, onViewChange, onMinimize, onClose }) => {
    ...
    return (
        <div className="header">
            ...
            <div className="header-actions">
                    ...
                    <>
                        ...
                        <Button className="button" variant="ghost">
                            ...
                            <span className="key" style={{ pointerEvents: 'none' }}>
                                {window.cheddar?.isMacOS ? 'Cmd' : 'Ctrl'}
                            </span>
                            &nbsp;&nbsp;
                            <span className="key">\</span>
                        </Button>
                        <Button className="icon-button window-close" variant="ghost" onClick={onClose}>
                            <CloseIcon />
                        </Button>
                    </>
                )}
                ...
                {currentView === 'main' && (
                    <>
                        <Button className="icon-button" variant="ghost" title="Conversation History" onClick={() => onViewChange('history')}>
                            <HistoryIcon />
                        </Button>
                        <Button className="icon-button" variant="ghost" title="Advanced Tools" onClick={() => onViewChange('advanced')}>
                            <AdvancedIcon />
                        </Button>
                        <Button className="icon-button" variant="ghost" title="Customize" onClick={() => onViewChange('customize')}>
                            <SettingsIcon />
                        </Button>
                        <Button className="icon-button" variant="ghost" title="Help & Shortcuts" onClick={() => onViewChange('help')}>
                            <HelpIcon />
                        </Button>
                        <Button className="icon-button window-close" variant="ghost" onClick={onClose}>
                            <CloseIcon />
                ...
                {currentView === 'onboarding' && (
                    <Button className="icon-button window-close" variant="ghost" onClick={() => onViewChange('main')}>
                        <CloseIcon />
                    </Button>
                )}
                ...
                {isNavigationView() && (
                    <>
                        <Button className="icon-button" variant="ghost" title="Back to Main" onClick={() => onViewChange('main')}>
                            <BackIcon />
                        </Button>
                        <Button className="icon-button window-close" variant="ghost" onClick={onClose}>
                            <CloseIcon />
